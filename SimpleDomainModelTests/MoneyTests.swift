...
class MoneyTests: XCTestCase {
    ...
    func testExtension() {
        XCTAssert(10.0.USD.description == tenUSD.description)
        XCTAssert(12.0.USD.description == twelveUSD.description)
        XCTAssert(5.0.GBP.description == fiveGBP.description)
        XCTAssert(15.0.EUR.description == fifteenEUR.description)
    }
